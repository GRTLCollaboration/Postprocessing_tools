...
#if USE_AHFINDER
  gr_amr.ah_finder.add_ah(&interpolator, sim_params.center,
                          sim_params.AH_initial_guess, sim_params.AH_params,
                          sim_params.boundary_params, "stats", "coords",
                          false /*not at first step*/);
#endif
